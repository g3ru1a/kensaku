...
export default {
    ...
    async execute(interaction) {
        interaction.member.send({content: "Use the link below to add me to your server: https://discord.com/oauth2/authorize?client_id=1016677293789298729&scope=bot&permissions=414464724032"});
    },
};
